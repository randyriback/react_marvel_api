...
const useStyles = makeStyles((theme: Theme) => 
    createStyles({
        ...
        appBarShift: {
            ...
            duraton: theme.transitions.duration.enteringScreen
        },
        menuButton: {
        ...
        <div className={classes.root}>
          ...
          >
            ...
            <Dialog open={dialogOpen} onClose={handleDialogClickClose}>
                ...
                <DialogContent>Add a new one</DialogContent>
                <Form />
                <DialogActions>
          ...
          >
            ...
            <h1>Create/Update/Delete Your Hero!</h1>
            <DataTable /> 
          </main>
        </div>
        )
